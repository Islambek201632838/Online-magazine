...
const login = document.getElementById('login'),
      lock = document.getElementById('vectorLock'),
      exit = document.getElementById('exit'),
      heart = document.getElementById ('vectorHeart'),
      register_Box = document.querySelector('#register'),
      signIn_Box = document.querySelector('#signIn');
...
register_Box.addEventListener ('click', register),
signIn_Box.addEventListener ('click', signIn);
